                ...
                <div className="result-on-box">
                    ...
                    <div className="result-box">
                        {word.map((item, index) => (
                            ...
                            <div
                                className={"result-box-content index" + (index) + ((kind && answer[index] && checkAnswer(item.word_meaning, answer[index][0])) || (!kind && answer[index] && item.word_content === answer[index][0]) ? " success" : " fail")}
                                key={index}>
