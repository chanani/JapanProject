...
import com.project.thejapenproject.config.EmitterRepository;
...
public class EmitterService {
  ...
  /*  @KafkaListener(topics = "dev-topic", groupId = "group_1")
    public void listen(NotificationMessage message) {
        NotificationMessage notifications = NotificationMessage.builder()
