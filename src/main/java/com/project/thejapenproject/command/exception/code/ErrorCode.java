...
public enum ErrorCode {
    ...
    WRONG_PARAM_NAME_LENGTH(HttpStatus.BAD_REQUEST, "회원가입시 이름의 길이는 2자 이상이어야 합니다."),
    WRONG_PARAM_PHONE_LENGTH(HttpStatus.BAD_REQUEST, "회원가입시 핸드폰 번호는 최소 9자 이상이어야 합니다."),
    ...
    NOT_FOUND_EMAIL(HttpStatus.UNAUTHORIZED, "사용자의 E-mail을 찾을 수 없습니다."),

    DO_NOT_USER_MATCHING(HttpStatus.UNAUTHORIZED, "이메일 또는 패스워드가 잘못되었습니다."),
    ...
    NOT_APPROVED_ACCOUNT(HttpStatus.UNAUTHORIZED, "승인되지 않은 교수자 계정입니다."),
    INVALID_USERTYPE(HttpStatus.UNAUTHORIZED, "잘못된 사용자 유형입니다."),
